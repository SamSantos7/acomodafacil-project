...
import { useRef } from "react"; // Added back useRef import


export default function Home() {
  const [offsetY, setOffsetY] = useState(0)
  const [activeSlide, setActiveSlide] = useState(0)
  const featuredRef = useRef<HTMLDivElement>(null) //Re-added useRef
        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl mb-8">
              Encontre as melhores acomodações para sua experiência de estudos na Irlanda
            </p>
            <Link
              href="/acomodacoes"
              className="inline-block bg-amber-500 text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-amber-600 transition-colors"
            >
